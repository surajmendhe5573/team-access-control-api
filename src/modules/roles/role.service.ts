...
class RoleService {
    ...
    async seedDefaultRoles(organizationId: string): Promise<Record<string, string>> {
    ...
    async update(organizationId: string, roleId: string, data: UpdateRoleInput) {
    ...
    private async assertRoleInOrg(organizationId: string, roleId: string) {
